...
| `build-chain-registry.ts` | writes-disk | Regenerates `backend/data/chain-registry.json` from the RPC sweep input. |
| `custody-demo.ts` | writes-disk | Before/after demo of the custody-declaration rule. |
